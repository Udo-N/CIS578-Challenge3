    ...
    switch (fid)
    {
      case 1:
        if (ftype == ::apache::thrift::protocol::T_I32) {
          ...
          this->bevType = (BeverageType::type)ecast8;
          this->__isset.bevType = true;
        } else {
...
uint32_t BeveragePreferenceService_getBeverage_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  ...
  xfer += oprot->writeFieldBegin("bevType", ::apache::thrift::protocol::T_I32, 1);
  xfer += oprot->writeI32((int32_t)this->bevType);
...
void BeveragePreferenceServiceClient::getBeverage(std::string& _return, const BeverageType::type bevType)
{
  send_getBeverage(bevType);
  recv_getBeverage(_return);
}

void BeveragePreferenceServiceClient::send_getBeverage(const BeverageType::type bevType)
{
  int32_t cseqid = 0;
...
void BeveragePreferenceServiceProcessor::process_getBeverage(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    iface_->getBeverage(result.success, args.bevType);
...
void BeveragePreferenceServiceConcurrentClient::getBeverage(std::string& _return, const BeverageType::type bevType)
{
  int32_t seqid = send_getBeverage(bevType);
  recv_getBeverage(_return, seqid);
}

int32_t BeveragePreferenceServiceConcurrentClient::send_getBeverage(const BeverageType::type bevType)
{
