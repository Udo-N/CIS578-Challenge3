...
class Client(Iface):
    ...
    def getBeverage(self, bevType):
        ...
        """
        self.send_getBeverage(bevType)
        return self.recv_getBeverage()

    def send_getBeverage(self, bevType):
...
class Processor(Iface, TProcessor):
    ...
    def process_getBeverage(self, seqid, iprot, oprot):
        ...
        result = getBeverage_result()
        try:
            result.success = self._handler.getBeverage(args.bevType)
...
class getBeverage_args(object):
    ...
    def __init__(self, bevType=None,):
    ...
    def write(self, oprot):
        ...
        if self.bevType is not None:
            oprot.writeFieldBegin('bevType', TType.I32, 1)
            oprot.writeI32(self.bevType)
            oprot.writeFieldEnd()
...
getBeverage_args.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'bevType', None, None, ),  # 1
)
